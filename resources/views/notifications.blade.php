...
<head>
    <meta charset="UTF-8">
    <title>Notifications | Bella Vista Suites</title>
...
<div class="page">
    ...
    <main>
        ...
        <section class="hero">
            <div class="eyebrow">Bella Vista Reservation Updates</div>

            <h2>
                My <strong>Notifications</strong>
            </h2>

            <p>
                Stay updated with your hotel reservation activity, booking confirmations, room status changes, and important messages from Bella Vista Suites.
            </p>

            <div class="hero-actions">
                <a href="{{ route('my-reservations') }}" class="hero-btn primary">
                    View Reservations
                </a>

                <a href="{{ route('book-now') }}" class="hero-btn secondary">
                    Create Reservation
                </a>
            </div>
        </section>
        ...
        <section class="notification-panel">
            <div class="panel-heading">
                <div>
                    ...
                    <p>All reservation updates from your account will appear here.</p>
                </div>
                    ...
                    @foreach($items as $notification)
                        @php
                            ...
                            $message = $data['message']
                                ?? 'Your reservation activity has been recorded.';

                            $bookingCode = $data['booking_code']
                                ?? $data['booking_id']
                                ?? 'N/A';

                            $roomName = $data['service_name']
                                ?? $data['room']
                                ?? $data['room_name']
                                ?? 'N/A';
                        ...
                        <article class="notification-card {{ $notification->read_at ? 'read' : '' }}">
            ...
            @else
                <div class="empty">
                    ...
                    <p>
                        Your reservation updates and booking activity will appear here once available.
                    </p>

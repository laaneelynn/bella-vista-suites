<nav class="bg-white/90 backdrop-blur-xl border-b border-gray-100 sticky top-0 z-50">
        ...
        <div class="flex justify-between h-20">
            ...
            <div class="flex items-center">
                ...
                <a href="{{ route('dashboard') }}" class="flex items-center gap-3">
                    <div class="h-11 w-11 rounded-2xl bg-gradient-to-br from-indigo-600 to-violet-600 flex items-center justify-center shadow-lg shadow-indigo-200">
                        <span class="text-white font-black text-xl">B</span>
                    </div>

                    <div class="hidden sm:block">
                        <h1 class="font-black text-gray-900 leading-tight">BookingPro</h1>
                        <p class="text-xs text-gray-500 -mt-1">Hotel Reservation System</p>
                    </div>
                </a>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center gap-3 px-4 py-2 border border-gray-200 text-sm leading-4 font-semibold rounded-2xl text-gray-700 bg-white hover:bg-gray-50 transition shadow-sm">
                            <div class="h-9 w-9 rounded-full bg-gradient-to-br from-indigo-500 to-violet-500 flex items-center justify-center text-white font-bold">
                                {{ strtoupper(substr(Auth::user()->name, 0, 1)) }}
                            </div>

                            <div class="text-left">
                                <div>{{ Auth::user()->name }}</div>
                                <div class="text-xs text-gray-400 font-normal">Registered User</div>
                            </div>

...
<head>
    <meta charset="UTF-8">
    <title>Bella Vista Suites Reservation</title>
</head>
                ...
                <tr>
                    <td style="padding:34px 34px 20px;">
                        ...
                        <p style="margin:0 0 22px; color:#514543; font-size:16px; line-height:1.7;">
                            Your room reservation has been successfully created. Below are your booking details.
                        </p>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" style="padding:10px 0;">
                                                @if($statusKey === 'confirmed')
                                                    <span style="display:inline-block; padding:8px 13px; border-radius:999px; background:#dcfce7; color:#166534; font-size:12px; font-weight:bold;">
                                                        {{ $status }}
                                                    </span>
                                                @elseif($statusKey === 'completed')
                                                    <span style="display:inline-block; padding:8px 13px; border-radius:999px; background:#dbeafe; color:#1d4ed8; font-size:12px; font-weight:bold;">
                                                        {{ $status }}
                                                    </span>
                                                @elseif($statusKey === 'cancelled')
                                                    <span style="display:inline-block; padding:8px 13px; border-radius:999px; background:#ffe4e6; color:#be123c; font-size:12px; font-weight:bold;">
                                                        {{ $status }}
                                                    </span>
                                                @else
                                                    <span style="display:inline-block; padding:8px 13px; border-radius:999px; background:#fef3c7; color:#92400e; font-size:12px; font-weight:bold;">
                                                        {{ $status }}
                                                    </span>
                                                @endif
                                            </td>
                        ...
                        <p style="margin:0; color:#514543; font-size:15px; line-height:1.7;">
                            Thank you for choosing Bella Vista Suites. We are excited to welcome you.
                        </p>
                    </td>
                </tr>
